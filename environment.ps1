$global:Services = @(
    ...
    'pip-services-accounts-node'
    'pip-services-email-node'
    'pip-services-sms-node'
    'pip-services-emailsettings-node'
    'pip-services-smssettings-node'
    'pip-services-msgdistribution-node'
...
$global:Clients = @(
    'pip-clients-activities-node'
    'pip-clients-accounts-node'
    'pip-clients-email-node'
    'pip-clients-sms-node'
    'pip-clients-emailsettings-node'
    'pip-clients-smssettings-node'
    'pip-clients-msgdistribution-node'
